...
IC_XMACRO_TOKEN_KIND_OPERATOR(Plus, "+")
IC_XMACRO_TOKEN_KIND_OPERATOR(Minus, "-")
IC_XMACRO_TOKEN_KIND_OPERATOR(Slash, "/")
IC_XMACRO_TOKEN_KIND_OPERATOR(Percent, "%")
IC_XMACRO_TOKEN_KIND_OPERATOR(Less, "<")
IC_XMACRO_TOKEN_KIND_OPERATOR(Greater, ">")
IC_XMACRO_TOKEN_KIND_OPERATOR(LessEqual, "<=")
IC_XMACRO_TOKEN_KIND_OPERATOR(GreaterEqual, ">=")
IC_XMACRO_TOKEN_KIND_OPERATOR(Equal, "=")
IC_XMACRO_TOKEN_KIND_OPERATOR(EqualEqual, "==")
IC_XMACRO_TOKEN_KIND_OPERATOR(NotEqual, "!=")
