...
struct Visitable {
  ...
  auto visit(V &v, Args &&...args) const {
    return vtable<V>(static_cast<typename V::signature *>(nullptr))[which_](
 ...
 private:
  ...
  auto const &vtable(Ret (*)(Args...)) const {
    static constexpr std::array vtable_ = Nodes::value.reduce([](auto... ts) {
