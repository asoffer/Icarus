...
T Emitter<E>::EvaluateAs(ast::Expression const *expression) {
  ...
  T result;
  vm::Execute(f, vm::ExecutionState{GlobalTypeSystem, argument_slice}, {},
              result);
  return result;
}
