#ifndef ICARUS_CORE_LEXEME_H
#define ICARUS_CORE_LEXEME_H
...
struct Lexeme {
  // TODO: This set of lexemes is somewhat specific to our particular use case
  // and should either be simplified or parameterized.
  enum class Kind {
    LeftDelimiter  = 0,
    RightDelimiter = 1,
    Comma,
