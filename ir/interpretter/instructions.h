#ifndef ICARUS_IR_INNTERPRETTER_INSTRUCTIONS_H
#define ICARUS_IR_INNTERPRETTER_INSTRUCTIONS_H
...
template <typename T>
inline T ReadAndResolve(bool is_reg, base::untyped_buffer::const_iterator *iter,
                        ExecutionContext *ctx) {
  if (is_reg) {
...
#endif  // ICARUS_IR_INNTERPRETTER_INSTRUCTIONS_H
