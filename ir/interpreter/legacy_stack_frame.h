#ifndef ICARUS_IR_INTERPRETER_LEGACY_STACK_FRAME_H
#define ICARUS_IR_INTERPRETER_LEGACY_STACK_FRAME_H
...
struct LegacyStackFrame {
  ...
  LegacyStackFrame() = delete;
  LegacyStackFrame(ir::ByteCodeView bc, Stack &stack);
  LegacyStackFrame(Summary const &s, Stack &stack);
  ~LegacyStackFrame();
...
template <typename T>
concept FitsInRegister = (sizeof(T) <=
                          LegacyStackFrame::register_value_size) and
...
#endif  // ICARUS_IR_INTERPRETER_LEGACY_STACK_FRAME_H
