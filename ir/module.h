...
struct Module {
 ...
 private:
  uint32_t InsertFunctionIndex(type::Function const *fn_type);
  ...
  ModuleId module_id_;
  absl::flat_hash_map<type::Type, uint32_t> init_, destroy_;
  absl::flat_hash_map<std::pair<type::Type, type::Type>, uint32_t> copy_assign_,
