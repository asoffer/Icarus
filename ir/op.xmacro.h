...
OP_MACRO(CreateInterface,      CreateInterface,     core::Scope const *,     scope_)
...
OP_MACRO(JumpPlaceholder,      Jump,                void,                    block_seq_)
...
OP_MACRO(CreateScopeDef,       CreateScopeDef,      void,                    mod_)
