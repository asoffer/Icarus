...
using TypeConstructorInstructions =
    ir::InstructionSet<type::PtrInstruction, type::BufPtrInstruction,
                       ...
                       type::StructDataInstruction, type::StructInstruction,
                       type::AllocateStructInstruction, type::EnumInstruction,
                       type::FlagsInstruction>;
...
struct instruction_set_t
    : ir::InstructionSet<
          ...
          CastInstructions<
              ...
              uint8_t(ir::Integer), uint8_t(int8_t), uint8_t(uint16_t),
              uint8_t(int16_t), uint8_t(uint32_t), uint8_t(int32_t),
              uint8_t(uint64_t), uint8_t(int64_t), uint8_t(float),
              uint8_t(double), uint8_t(bool),
              // i8 from any numeric primitive
              int8_t(ir::Integer), int8_t(uint8_t), int8_t(uint16_t),
              ...
              uint16_t(ir::Integer), uint16_t(uint8_t), uint16_t(int8_t),
              uint16_t(int16_t), uint16_t(uint32_t), uint16_t(int32_t),
              uint16_t(uint64_t), uint16_t(int64_t), uint16_t(float),
              uint16_t(double), uint16_t(bool),
              // i16 from any numeric primitive
              int16_t(ir::Integer), int16_t(uint8_t), int16_t(int8_t),
              int16_t(uint16_t), int16_t(uint32_t), int16_t(int32_t),
              int16_t(uint64_t), int16_t(int64_t), int16_t(float),
              int16_t(double), int16_t(bool),
              // u32 from any numeric primitive
              uint32_t(ir::Integer), uint32_t(uint8_t), uint32_t(int8_t),
              uint32_t(uint16_t), uint32_t(int16_t), uint32_t(int32_t),
              uint32_t(uint64_t), uint32_t(int64_t), uint32_t(float),
              uint32_t(double), uint32_t(bool),
              // i32 from any numeric primitive
              int32_t(ir::Integer), int32_t(uint8_t), int32_t(int8_t),
              int32_t(uint16_t), int32_t(int16_t), int32_t(uint32_t),
              int32_t(uint64_t), int32_t(int64_t), int32_t(float),
              int32_t(double), int32_t(bool),
              // u64 from any numeric primitive
              uint64_t(ir::Integer), uint64_t(uint8_t), uint64_t(int8_t),
              uint64_t(uint16_t), uint64_t(int16_t), uint64_t(uint32_t),
              uint64_t(int32_t), uint64_t(int64_t), uint64_t(float),
              uint64_t(double), uint64_t(bool),
              // i64 from any numeric primitive
              int64_t(ir::Integer), int64_t(uint8_t), int64_t(int8_t),
              int64_t(uint16_t), int64_t(int16_t), int64_t(uint32_t),
              int64_t(int32_t), int64_t(uint64_t), int64_t(float),
