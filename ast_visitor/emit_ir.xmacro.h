ICARUS_AST_VISITOR(ir::Results EmitIr(ast_visitor::EmitIr const *visitor,
                                      Context *ctx) const,
...
ICARUS_AST_VISITOR(void EmitCopyInit(ast_visitor::EmitIr const *visitor,
                                     type::Typed<ir::Reg> reg, Context *ctx)
                       const,
                   { visitor->CopyInit(this, reg, ctx); });
ICARUS_AST_VISITOR(void EmitMoveInit(ast_visitor::EmitIr const *visitor,
                                     type::Typed<ir::Reg> reg, Context *ctx)
                       const,
...
ICARUS_AST_VISITOR(void ExtractJumps(ast_visitor::ExtractJumps *visitor) const,
                   { (*visitor)(this); });
