...
template <int Base>
std::variant<absl::int128, double, NumberParsingError> ParseIntInBase(
    std::string_view s) {
...
template <int Base>
std::variant<absl::int128, double, NumberParsingError> ParseRealInBase(
...
template <int Base>
std::variant<absl::int128, double, NumberParsingError> ParseNumberInBase(
    std::string_view sv) {
  std::string copy;
  for (char c : sv) {
