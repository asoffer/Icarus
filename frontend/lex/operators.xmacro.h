...
OPERATOR_MACRO(Needs, "needs", sop_l, 1, non_assoc)
OPERATOR_MACRO(Ensure, "ensure", sop_l, 1, non_assoc)
OPERATOR_MACRO(Print, "print", sop_l, 1, non_assoc)
...
OPERATOR_MACRO(Xor, "^", op_b, 13, left_assoc)
OPERATOR_MACRO(And, "&", op_bl, 14, left_assoc)
...
OPERATOR_MACRO(ArgType, "$", op_lt, 18, non_assoc)
OPERATOR_MACRO(Copy, "copy", op_l, 18, non_assoc)
OPERATOR_MACRO(Init, "init", op_l, 18, non_assoc)
