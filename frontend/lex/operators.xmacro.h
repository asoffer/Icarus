...
OPERATOR_MACRO(Add, "+", op_b, 15, left_assoc)
OPERATOR_MACRO(Sub, "-", op_bl, 15, left_assoc)
OPERATOR_MACRO(Mul, "*", op_bl, 16, left_assoc)
OPERATOR_MACRO(Div, "/", op_b, 16, left_assoc)
OPERATOR_MACRO(Mod, "%", op_b, 16, left_assoc)
OPERATOR_MACRO(As, "as", op_b, 17, left_assoc)
OPERATOR_MACRO(SymbolOr, "|", op_b, 18, chain_assoc)
OPERATOR_MACRO(SymbolXor, "^", op_b, 19, left_assoc)
OPERATOR_MACRO(SymbolAnd, "&", op_bl, 20, left_assoc)
OPERATOR_MACRO(ArgType, "$", op_lt, 21, non_assoc)
OPERATOR_MACRO(Copy, "copy", op_l, 21, non_assoc)
OPERATOR_MACRO(Init, "init", op_l, 21, non_assoc)
OPERATOR_MACRO(Move, "move", op_l, 21, non_assoc)
OPERATOR_MACRO(Not, "!", op_l, 22, right_assoc)
OPERATOR_MACRO(TypeOf, ":?", op_r, 22, right_assoc)
OPERATOR_MACRO(BufPtr, "[*]", op_l, 22, right_assoc)
OPERATOR_MACRO(At, "@", op_l, 22, right_assoc)
OPERATOR_MACRO(Index, "[]", expr, 23, chain_assoc)
OPERATOR_MACRO(Call, "'", op_bl, 24, left_assoc)
