...
OPERATOR_MACRO(Import,         "import",  op_l,      0,    non_assoc)
OPERATOR_MACRO(Return,         "return",  op_lt,     0,    non_assoc)
OPERATOR_MACRO(Yield,          "yield",   op_lt,     0,    non_assoc)
OPERATOR_MACRO(When,           "when",    op_b,      0,    non_assoc)
OPERATOR_MACRO(Needs,          "needs",   op_l,      0,    non_assoc)
OPERATOR_MACRO(Ensure,         "ensure",  op_l,      0,    non_assoc)
OPERATOR_MACRO(Print,          "print",   op_l,      0,    non_assoc)
OPERATOR_MACRO(Eval,           "$",       op_l,      0,    right_assoc)
OPERATOR_MACRO(Comma,          ",",       comma,     1,    chain_assoc)
OPERATOR_MACRO(Expand,         "<<",      op_l,      2,    right_assoc)
OPERATOR_MACRO(Assign,         "=",       eq,        3,    non_assoc)
OPERATOR_MACRO(ColonEq,        ":=",      op_b,      3,    non_assoc)
OPERATOR_MACRO(DoubleColonEq,  "::=",     op_b,      3,    non_assoc)
OPERATOR_MACRO(Colon,          ":",       colon,     4,    non_assoc)
OPERATOR_MACRO(DoubleColon,    "::",      colon,     4,    non_assoc)
...
OPERATOR_MACRO(And,            "&",       op_b,      14,   chain_assoc)
...
OPERATOR_MACRO(Access,         ".",       op_b,      24,   left_assoc)
OPERATOR_MACRO(NotAnOperator,  "_",       0,         100,  chain_assoc)
