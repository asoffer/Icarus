...
syntax keyword Keyword move copy import flags enum struct return scope as foreign bytes align opaque block init destroy and or xor not abort interface slice callable reserve_memory compilation_error
