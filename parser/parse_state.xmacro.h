...
IC_XMACRO_PARSER_STATE_KIND(CallExpression)
IC_XMACRO_PARSER_STATE_KIND(ResolveCallExpression)
IC_XMACRO_PARSER_STATE_KIND(ExpressionSuffix)
IC_XMACRO_PARSER_STATE_KIND(ResolveExpressionGroup)
IC_XMACRO_PARSER_STATE_KIND(ExpressionClosing)
