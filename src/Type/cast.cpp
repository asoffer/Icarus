...
llvm::Value* Primitive::call_cast(llvm::Value* val, TypePtr to_type) {
  if (this == Bool) {
...
llvm::Value *Pointer::call_cast(llvm::Value *val, TypePtr to_type) {
  return nullptr;
}
llvm::Value *Tuple::call_cast(llvm::Value *val, TypePtr to_type) {
  return nullptr;
}
llvm::Value *Function::call_cast(llvm::Value *val, TypePtr to_type) {
  return nullptr;
}
llvm::Value *Array::call_cast(llvm::Value *val, TypePtr to_type) {
  return nullptr;
}
