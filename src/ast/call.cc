...
IR::Val AsciiFunc() {
  static IR::Func *ascii_func_ = []() {
    ...
    CURRENT_FUNC(fn) {
      ...
      IR::SetReturn(
          0, IR::Val::Reg(Trunc(std::get<IR::Register>(fn->Argument(0).value)).reg_,
                          type::Int));
      IR::ReturnJump();
    }
    return fn;
...
IR::Val OrdFunc() {
  static IR::Func *ord_func_ = []() {
    ...
    CURRENT_FUNC(fn) {
      IR::BasicBlock::Current = fn->entry();
      IR::SetReturn(
          0, IR::Val::Reg(Extend(std::get<IR::Register>(fn->Argument(0).value)).reg_,
                          type::Char));
      IR::ReturnJump();
    }
    return fn;
...
IR::Val BytesFunc() {
  static IR::Func *bytes_func_ = []() {
    ...
    CURRENT_FUNC(fn) {
      IR::BasicBlock::Current = fn->entry();
      IR::SetReturn(
          0, IR::Val::Reg(Bytes(std::get<IR::Register>(fn->Argument(0).value)),
                          type::Int));
      IR::ReturnJump();
    }
    return fn;
...
IR::Val AlignFunc() {
  static IR::Func *bytes_func_ = []() {
    ...
    CURRENT_FUNC(fn) {
      IR::BasicBlock::Current = fn->entry();
      IR::SetReturn(
          0, IR::Val::Reg(Align(std::get<IR::Register>(fn->Argument(0).value)),
                          type::Int));
      IR::ReturnJump();
    }
    return fn;
