...
auto Rules = std::vector<Rule>{
    ...
    Rule(0x00, eof, {newline, eof}, drop_all_but<1>),
    ...
    Rule(0x02, l_double_brace, {l_double_brace, newline}, drop_all_but<0>),
    ...
    Rule(0x00, r_double_brace, {newline, r_double_brace}, drop_all_but<1>),
    Rule(0x00, l_brace, {newline, l_brace}, drop_all_but<1>),
    Rule(0x00, l_double_brace, {newline, l_double_brace}, drop_all_but<1>),
    ...
    Rule(0x00, r_double_brace, {r_double_brace, newline}, drop_all_but<0>),

    Rule(0x00, braced_stmts, {l_brace, stmts, stmts | expr | fn_expr, r_brace},
    ...
    Rule(0x03, expr, {EXPR, EXPR, braced_stmts}, AST::ScopeNode::Build),
    Rule(0x04, expr, {EXPR, braced_stmts}, AST::ScopeNode::BuildVoid),
